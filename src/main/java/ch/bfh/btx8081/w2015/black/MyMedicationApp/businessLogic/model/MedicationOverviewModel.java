...
/**
 * The medicationOverviewModel is used to display existing prescriptions and to
 * handle a prescriptionContext, which stores the actually chosen prescription.
 * 
...
public class MedicationOverviewModel extends Observable {
	...
	public void setSelectedPrescription(Prescription selectedPrescription) {
		if (selectedPrescription == null) {
			...
			Prescription p = prescriptionRepo.getById(selectedPrescription
					.getPrescriptionId());
